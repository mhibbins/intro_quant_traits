...
# This script simulates a single replicate gene expression dataset and tests for 
# significantly different expression covariance across 9 combinations of 
# t1 and number of traits. 
...
t2_vector <- rep(2, 9)
t1_vector <- rep(c(1, 1.5, 1.9), 3)
delta = 0
genes_vector <- rep(c(5000, 10000, 15000),
		    times = (c(3, 3, 3)))
